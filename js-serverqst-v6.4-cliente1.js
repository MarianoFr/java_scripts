        ...
        if(globalTag!=tag)
        {
          ...
          if(gpsFechaHora=="2021-01-01 08:00:00")
          {
            if((parseFloat(GPSlat) == 0) || (parseFloat(GPSlng) == 0))
            {
              ...
              query2 = "";
              //Actualiza uTambos
              query3 = "REPLACE INTO `insoltechv11`.`uTambos` (  `modem`,`tag`, `mapIcon`, `nroTambo`, `cantidad`, `patente`) VALUES ('" 
            ...
            else
            {
              ...
              query2 = "INSERT INTO `insoltechv11`.`gpspos` (  `modem`, `GPSlat`, `GPSlng`, `Velocidad`, `Kilometros`, `Accuracy`, `tag`, `mapIcon`, "
                ...
                //Actualiza uTambos
              query3 = "REPLACE INTO `insoltechv11`.`uTambos` (  `modem`, `GPSlat`, `GPSlng`,`tag`, `mapIcon`, `nroTambo`, `cantidad`, `patente`) VALUES ('" 
          ...
          else
          {
            ...
            //Actualiza uTambos
            query3 = "REPLACE INTO `insoltechv11`.`uTambos` (  `modem`, `GPSlat`, `GPSlng`,`tag`, `gpsTime`, `mapIcon`, `nroTambo`, `cantidad`, `patente`) VALUES ('" 
