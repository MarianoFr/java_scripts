...
{
  if(topic.includes('cliente1'))
  {
    var msg = message.toString();
    console.log("Mensaje recibido desde -> " + topic + " Mensaje -> " + msg);
    
    if(topic.includes('cliente1/report'))
    {
      if(msg == "")
      {
      ...
      else
      {
        ...
        if(type == "ACK")
        {
          var query_ack = "UPDATE `insoltechv11`.`reconfig_time` " +
    ...
    else if(topic.includes('cliente1/reconfig'))
    {
      if(msg == "")
      {
    ...
    else if(!topic.includes('report'))
    {
        ...
        if(globalTag!=tag)
        {
          ...
          {  
            con.query(queryInfo, function (err, result, fields) 
            {
                ...
                {                
                    ...
                    { //Se inserta fila info
                        ...
                        else
                        {
                            AccuracyGlobal = 20.0;
                            //Se inserta fila info
                            query1 = "INSERT INTO `insoltechv11`.`info` (`modem`, `nroInfo`,`touridx`, `infono`, `FechaHora`, `GPSlat`," 
                            ...
                            //Se inserta fila gpspos con ícono de info
                            query2 = "INSERT INTO `insoltechv11`.`gpspos` (  `modem`, `GPSlat`, `GPSlng`, `Velocidad`, `Kilometros`, `Accuracy`, `tag`, `mapIcon`, "
                    ...
                    { //Se inserta fila info
                        ...
                        //Se inserta fila gpspos con ícono de info
                        query2 = "INSERT INTO `insoltechv11`.`gpspos` (  `modem`, `GPSlat`, `GPSlng`, `Velocidad`, `Kilometros`, `Accuracy`, `gpsTime`, `tag`, `mapIcon`, "
                        +"`IconName`, `patente`) VALUES ('" + modem + "', '" + GPSlat +"', '" + GPSlng + "', '" + Velocidad + "', '" 
                ...
                {
                    var queryError = "INSERT INTO `insoltechv11`.`errores` (`mensaje`) VALUES ('" + msg + "');";
      ...
      if (topic == "cliente1/recorrido")
      {
        if(actualizado)
        {
          ...
          var chofer = json_parser['fld']['drv'];
          var contadorMuestras = json_parser['fld']['CM'];
        ...
        if(globalTag!=tag)
        {
          ...
          if(gpsFechaHora=="2021-01-01 08:00:00")
          {
            query1 = "INSERT INTO `insoltechv11`.`recorrido` (`modem`,`nroRecorrido`,`touridx`, `nroCamion`,`nroCuenta`, "
      ...
      if (topic == "cliente1/tambo")
      {
        if(actualizado)
        {
          ...
          var constanteC = json_parser['fld']['ctC'];//var constanteC = json_parser['fld']['ctC'];        
        ...
        else
        {
          ...
          var touridx = json_parser['fld']['tid'];
          var remito = "";
          var codigoTambero = json_parser['fld']['rmt'];
          var cantidadTotal = json_parser['fld']['cTm'];  
          var compA = json_parser['fld']['CT']; 
          var observaciones = json_parser['fld']['obs'];
          var cantidadA = json_parser['fld']['obs'];
          var compB = json_parser['fld']['cA'];
          var cantidadB = json_parser['fld']['cnA'];
          var compC = json_parser['fld']['cB'];
          var cantidadC = json_parser['fld']['cnB'];
          var tempAver = json_parser['fld']['cC'];
          var tempMin = json_parser['fld']['cnC'];
          var tempMax = json_parser['fld']['tAv'];
          var status = json_parser['fld']['tMn'];
          var litrosTmuestra = json_parser['fld']['tMx'];
          var desaInicial = json_parser['fld']['stt'];
          var desaFinal = json_parser['fld']['LTM'];
          var constanteE = json_parser['fld']['daI'];
          var constanteC = json_parser['fld']['daF'];//var constanteC = json_parser['fld']['ctC'];        
          var sampleID = json_parser['fld']['ctE'];
          var fechaHoraInicio = json_parser['fld']['FHI'];
          //if(fechaHoraInicio)
        ...
        if(globalTag!=tag)
        {
          ...
          if(gpsFechaHora=="2021-01-01 08:00:00")
          {
            if((parseFloat(GPSlat) == 0) || (parseFloat(GPSlng) == 0))
            {
              query1 = "INSERT INTO `insoltechv11`.`tambo` ( `modem`, `nroTambo`, `touridx`, `remito`, `observaciones`, `codigoTambero`, `cantidadTotal`, `compa`,"
              ...
              query2 = "";
              //Actualiza uTambos
              query3 = "REPLACE INTO `insoltechv11`.`uTambos` (  `modem`,`tag`, `mapIcon`, `nroCamion`, `nroTambo`, `cantidad`, `patente`) VALUES ('" 
            ...
            else
            {
              ...
              query2 = "INSERT INTO `insoltechv11`.`gpspos` (  `modem`, `GPSlat`, `GPSlng`, `Velocidad`, `Kilometros`, `Accuracy`, `tag`, `mapIcon`, "
                ...
                //Actualiza uTambos
              query3 = "REPLACE INTO `insoltechv11`.`uTambos` (  `modem`, `GPSlat`, `GPSlng`,`tag`, `mapIcon`, `nroCamion`, `nroTambo`, `cantidad`, `patente`) VALUES ('" 
          ...
          else
          {
            ...
            //Se inserta fila gpspos con ícono de tambo
            query2 = "INSERT INTO `insoltechv11`.`gpspos` (  `modem`, `GPSlat`, `GPSlng`, `Velocidad`, `Kilometros`, `Accuracy`, `tag`, `gpsTime`, `mapIcon`, "
              +"`IconName`, `patente`) VALUES ('" + modem + "', '" + GPSlat +"', '" + GPSlng + "', '" + Velocidad + "', '" 
              + Kilometros + "', '" + AccuracyGlobal + "', '" + tag + "', '" + gpsFechaHora + "', '" + tambo_icon + "', 'Tambo', '" + rx_patente + "');";

            //Actualiza uTambos
            query3 = "REPLACE INTO `insoltechv11`.`uTambos` (  `modem`, `GPSlat`, `GPSlng`,`tag`, `gpsTime`, `mapIcon`, `nroCamion`, `nroTambo`, `cantidad`, `patente`) VALUES ('" 
      ...
      if (topic == "cliente1/cip")
      {
        ...
        if(globalTag!=tag)
        {
          ...
          { //Se inserta fila cip
            if((parseFloat(GPSlat) == 0) || (parseFloat(GPSlng) == 0))
            {
              query1 = "INSERT INTO `insoltechv11`.`cip` (  `modem`, `nroCip`, `touridx`, `nroCamion`, `tempaver`, `tempmin`, `tempmax`,"
            ...
            else
            {
              ...
              AccuracyGlobal = 20;
            //Se inserta fila gpspos con ícono de cip
              query2 = "INSERT INTO `insoltechv11`.`gpspos` (  `modem`, `GPSlat`, `GPSlng`, `Velocidad`, `Kilometros`, `Accuracy`, `tag`, "
          ...
          { //Se inserta fila cip
            ...
            //Se inserta fila gpspos con ícono de cip
            query2 = "INSERT INTO `insoltechv11`.`gpspos` (  `modem`, `GPSlat`, `GPSlng`, `Velocidad`, `Kilometros`, `Accuracy`, `tag`, `gpsTime`, "
              + "`mapIcon`, `IconName`, `patente`) VALUES ('" + modem + "', '" + GPSlat +"', '" + GPSlng + "', '" + Velocidad
      ...
      if (topic == "cliente1/trasvase")
      {
        ...
        var trailerNo = json_parser['fld']['trailN'];
        ...
        if(globalTag!=tag)
        {
          ...
          { //Se inserta fila trasvase
            if((parseFloat(GPSlat) == 0) || (parseFloat(GPSlng) == 0))
            {
              query1 = "INSERT INTO `insoltechv11`.`trasvase` (  `modem`, `nroTrasvase`, `touridx`, `Sourcecomp`, `destcomp`, `trailerno`,"
            ...
            else
            {
              query1 = "INSERT INTO `insoltechv11`.`trasvase` (  `modem`, `nroTrasvase`, `touridx`, `Sourcecomp`, `destcomp`, `trailerno`,"
                ...
                AccuracyGlobal = 20;
              //Se inserta fila gpspos con ícono de trasvase
              query2 = "INSERT INTO `insoltechv11`.`gpspos` (  `modem`, `Velocidad`, `Kilometros`, `Accuracy`, `GPSlat`, `GPSlng`, `tag`,"
      ...
      if (topic == "cliente1/gps") 
      {
        ...
        if(globalTag!=tag)
        {
          ...
          con.query(query0, function (err, result, fields)
          {
            ...
            var query2 = "INSERT INTO `insoltechv11`.`gpspos` (  `modem`, `GPSlat`, `GPSlng`, `Velocidad`, `Kilometros`, `Accuracy`, `tag`,"
            ...
            con.query(query2, function (err, result, fields) 
            {
              if (err) throw err;
              console.log("Fila 'gpspos' insertada correctamente");
              var query = "REPLACE INTO `insoltechv11`.`uPos` (`modem`, `GPSlat`, `GPSlng`, `Velocidad`, `Kilometros`, `tag`, `gpsTime`, "
      ...
      if (topic == "cliente1/fails")
      {
        ...
        var query = "INSERT `insoltechv11`.`alertas` SET `modem` = '" + modem + "', `SD` = '" + sd
        ...
        if(gpsFechaHora=="2021-01-01 08:00:00")
        {
          query = "INSERT `insoltechv11`.`alertas` SET `modem` = '" + modem + "', `SD` = '" + sd
          + "', `Q` = '" + q + "', `GPS` = '" + gps + "', `resets` = '" + nro_resets + "', `GPSlat` = '"
      ...
      if (topic == "cliente1/parametros")
      {
        ...
        if(globalTag!=tag)
        {
          ...
          if(gpsFechaHora=="2021-01-01 08:00:00")
          {
            query_param = "INSERT INTO `insoltechv11`.`param_report` ( `modem`, `uNbr`, `trailN`," +
      ...
      else
      {
        try
        {
          if(update_sent!=String(result[0]['update']))
          {
            ...
            var topic = "cliente1/reconfig/" + String(result[0]['modem']);
      ...
      else
      {
        try
        {
          ...
          if(last_sol != String(result[0]['solicitud']))
          {
            ...
            sol_topic = "cliente1/report/" + result[0]["modem"];
            sol_msg = '{"msg":"REPORT"}';
